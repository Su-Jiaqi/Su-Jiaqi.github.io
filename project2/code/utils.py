...
if __name__ == "__main__":
    # 1. load the image
    image1 = plt.imread('F:/UCB/CS180/project2/origin_photo/nutmeg.jpg')
    image2 = plt.imread('F:/UCB/CS180/project2/origin_photo/DerekPicture.jpg')
    # 2. align the two images by calling align_images
    image1_aligned, image2_aligned = align_images(image1, image2)
    # 3. display the aligned images
    plt.imshow(image1_aligned)
    plt.show()
    plt.imshow(image2_aligned)
    plt.show()
